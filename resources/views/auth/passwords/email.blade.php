                ...
                <div class="p-2">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email') }}" autocomplete="off" autofocus placeholder="Enter email" required>
                            @error('email')
