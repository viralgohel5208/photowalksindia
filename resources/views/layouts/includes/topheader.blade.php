        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="#" class="logo logo-light">
                    <span class="logo-sm">
                        {{-- <img src="{{ asset('assets/images/logo-icon.png') }}" alt="" height="30"> --}}
                        <span class="logo-text">P</span>
                    </span>
                    <span class="logo-lg">
                        {{-- <img src="{{ asset('assets/images/logo.png') }}" alt="" height="45"> --}}
                        <span class="logo-text">Photowalk</span>
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('admin.profile') }}">
                        <i class="bx bx-lock-open font-size-16 align-middle me-1"></i> <span key="t-lock-screen">Change Password</span>
                    </a>
