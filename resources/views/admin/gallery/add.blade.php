...
@section('content')
	<div class="row">
	    <div class="col-12">
	        <div class="card">
	            <div class="card-body">
	            	<form action="{{ route('admin.gallery.pagedata.store') }}" name="addfrm" id="addfrm" method="POST" class="outer-repeater" enctype="multipart/form-data">
	            	    @csrf
                        <input type="hidden" id="id" name="id" value="{{ isset($galleryPageContent) ? $galleryPageContent->id : '' }}" />
                        <h4>Seo Section</h4>
                        <div class="row">
                            <div class="mb-3 col-6">
                                <label class="form-label" for="page_title">Page Title</label>
                                <input type="text" class="form-control" id="page_title" name="page_title" value="{{ old('page_title', isset($galleryPageContent) ? $galleryPageContent->page_title : '') }}" />
                                @error('page_title')
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" class="form-control" id="meta_tag" name="meta_tag" value="{{ old('meta_tag', isset($galleryPageContent) ? $galleryPageContent->meta_tag : '') }}" />
                                @error('meta_tag')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <textarea name="meta_description" id="meta_description" class="form-control">{{ old('meta_description', isset($galleryPageContent) ? $galleryPageContent->meta_description : '') }}</textarea>
