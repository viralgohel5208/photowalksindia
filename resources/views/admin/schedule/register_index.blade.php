        ...
        <div class="col-12">
            <div class="card">
                <div class="row">
                    <div class="col-8"></div>
                    <div class="col-4">
                        <label for="export-option">Export Excel</label>
                        <select class="form-control" onchange="exportExcel(this.value)">
                            <option>-- Select Schedule --</option>
                            <option value="0">-- All --</option>
                            @if(isset($schedule_name) && !empty($schedule_name))
                                @foreach($schedule_name as $key => $value)
...
@section('page-script')
    ...
    <script type="text/javascript">
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        url: "{!! route('admin.schedule.register_delete') !!}",
                        dataType: 'json',
                        data: {
                            id: id
                        },
        ...
        function exportExcel(id) {
            window.location = '{!! route('admin.schedule.register_export') !!}?schedule_id='+id;
        }
    </script>
@endsection
