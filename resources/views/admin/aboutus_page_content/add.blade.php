	            	...
	            	<form action="{{ route('admin.aboutus_page_content.store') }}" name="addfrm" id="addfrm" method="POST" class="outer-repeater" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" class="form-control" id="page_title" name="page_title" value="{{ old('page_title', isset($aboutUsPageContent) ? $aboutUsPageContent->page_title : '') }}" />
                                @error('page_title')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" class="form-control" id="meta_tag" name="meta_tag" value="{{ old('meta_tag', isset($aboutUsPageContent) ? $aboutUsPageContent->meta_tag : '') }}" />
                                @error('meta_tag')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <textarea name="meta_description" id="meta_description" class="form-control">{{ old('meta_description', isset($aboutUsPageContent) ? $aboutUsPageContent->meta_description : '') }}</textarea>
